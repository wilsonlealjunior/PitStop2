...
public class RelatorioVendasActivity extends AppCompatActivity {
    ...
    VendaAdapter vendasReyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vendasReyclerViewAdapter = new VendaAdapter(relatorioVendas, this);
...
//                        Toast.makeText(getApplicationContext(), "Verifique a conexao com a internet", Toast.LENGTH_SHORT).show();
        ...
        vendasReyclerViewAdapter.setOnItemClickListener(new VendaAdapter.ItemClickListener() {
            @Override
        ...
        vendasReyclerViewAdapter.setOnItemDeleteListener(new VendaAdapter.ItemDeleteListener() {
            @Override
...
//            Toast.makeText(getApplicationContext(), "A data de origem deve ser menor do que a data final ", Toast.LENGTH_SHORT).show();
    ...
    private void ShowCustomDialogwithList() {
        ...
        DescricaoVendaAdapter tabelaDescricaoVendaRecicleViewAdapter;
        recyclerView = (RecyclerView) dialogView.findViewById(R.id.listview);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);
        tabelaDescricaoVendaRecicleViewAdapter = new DescricaoVendaAdapter(vendaClicada.getItemVendas(), this);

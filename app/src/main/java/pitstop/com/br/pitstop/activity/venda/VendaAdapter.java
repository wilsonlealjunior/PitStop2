...
public class VendaAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public VendaAdapter(List<Venda> item_list, Context context) {
        this.item_list = item_list;
        this.context = context;
        up = new UsuarioPreferences(context);
    }

    public void setOnItemClickListener(VendaAdapter.ItemClickListener itemClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_venda, parent, false);
        ...
        if (item_list.size() > 0) {
            ...
            if (up.temUsuario()) {
                if (up.getUsuario().getRole().equals("Funcionario")) {
                    ...
                    ((ViewHolder) holder).lucroHeader.setVisibility(View.GONE);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener, View.OnClickListener {
        ...
        public ViewHolder(View view) {
            ...
            lucroHeader = (TextView) view.findViewById(R.id.lucro_header);

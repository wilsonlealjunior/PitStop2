...
public class AvariaAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AvariaAdapter(List<Avaria> item_list, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_avaria, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (item_list.size() > 0) {
            final Avaria items = item_list.get(position);
            ...
            ((ViewHolder) holder).prejuizo.setText(Util.moedaNoFormatoBrasileiro(items.getPrejuizo()));
